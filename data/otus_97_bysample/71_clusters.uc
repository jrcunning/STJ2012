# uclust --input /tmp/UclustExactMatchFilter0NvCaV.fasta --id 0.97 --tmpdir /tmp --optimal --w 8 --stepwords 8 --usersort --maxaccepts 1 --stable_sort --maxrejects 8 --uc data/otus_97_bysample/71_clusters.uc
# version=1.2.22
