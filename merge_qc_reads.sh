...
# Trim forward primers (allow error rate of 15% (3 indels/mismatches))
cutadapt -g GTGAATTGCAGAACTCCGTG -e 0.15 data/fasta/combined_seqs_chimera_filtered.fasta -o data/fasta/trimF.fasta
...
cutadapt -a AAGCATATAAGTAAGCGGAGG -e 0.15 data/fasta/trimF2.fasta -o data/fasta/trimF2_trimR.fasta
# Trim reverse primers again for any remaining internally
cutadapt -a AAGCATATAAGTAAGCGGAGG -e 0.15 data/fasta/trimF2_trimR.fasta -o data/fasta/combined_seqs_trimmed.fasta
