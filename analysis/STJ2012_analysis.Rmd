...
```{r betadisper, cache=T, fig.width=8, fig.height=4}
betad <- function(phy) {
...
par(mfrow=c(1,2), mar=c(3.5,4,2,1), lwd=1)
...
otubarplot <- function(phy, main) {
  ...
  bars <- barplot(typerelabund, col=rainbow(ntaxa(phy)), las=1, space=0.1, xaxs="i",
                  xlab="", ylab="", cex.axis=0.75, cex.names=0.75, xaxt="n")
  text(bars, -0.06, labels=samples, xpd=T, cex=0.75)
  text(bars, -0.10, labels=shores, xpd=T, cex=0.75)
  text(bars, -0.14, labels=substr(sites, 1, 2), xpd=T, cex=0.75)
  text(bars[1]/4, c(-0.06, -0.10, -0.14), labels=c("sample:", "shore:", "site:"), xpd=T, cex=0.75, pos=2)
...
### *Diploria strigosa*
```{r dstr, cache=T, fig.height=8, fig.width=8}
...
par(mfrow=c(2,1), mar=c(2.2,3,2,1), lwd=0.1)
otubarplot(dstr97.f.p, main="97% OTUs")
otubarplot(dstr100.f.p, main="100% OTUs")
```

### *Porites furcata*
```{r pfur, cache=T, fig.height=8, fig.width=8}
...
### *Orbicella annularis*
```{r oann, cache=T, fig.height=8, fig.width=8}
...
```{r malc, cache=T, fig.height=8, fig.width=8}
...
### *Siderastrea siderea*
```{r ssid, cache=T, fig.height=8, fig.width=8}
...
### *Favia fragum*
```{r ffra, cache=T, fig.height=8, fig.width=8}
...
### *Siderastrea radians*
```{r srad, cache=T, fig.height=8, fig.width=8}
...
### *Porites astreoides*
```{r past, cache=T, fig.height=8, fig.width=8}
...
```{r dcyl, cache=T, fig.height=8, fig.width=8}
...
```{r mcav, cache=T, fig.height=8, fig.width=8}
