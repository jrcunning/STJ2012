...
#### *Symbiodinium* metacommunity ecology in St. John
  ...
  While environmental data revealed significant biophysical differences between the north and south shores of the island (e.g., wave exposure, temperature, and chlorophyll A), there were no significant differences in symbiont community composition in the host species sampled on either shore. This may partly be due to low statistical power associated with small sample sizes, since two species showed clear trends: *S. siderea* and *P. furcata* were dominated more frequently by *Symbiodinium* in clades D and A, respectively, on the south shore, compared to the north shore (Fig. 2). Since these symbionts are typically associated with warmer and more variable temperature regimes [e.g., @Baker:2004p21; @Oliver:2011cr] and high-light habitats [@LaJeunesse:2002p3917], it is consistent with expectations that they were more prevalent on the south shore, where temperatures were slightly higher, and chlorophyll levels were lower, suggesting greater light penetration. However, the lack of differentiation in the symbiont communities of most host species suggests their structure is not sensitive to environmental differences between shores.
  
  When the associations between *Symbiodinium* types and coral species were visualized by network analysis, features of both symbiont and host ecology emerge. First, ITS2 type B1 was "abundant" (i.e. >1%) in seven out of ten coral species, and "dominant" (i.e. >50%) in five out of ten, suggesting it is a more generalist symbiont lineage. However, analysis of more variable chloroplast and microsatellite loci has revealed that ITS2 type B1 in the Caribbean is comprised of numerous specialized lineages that demonstrate specific associations with different coral host species [@Santos:2004p4044; @Finney:2010p8324; @Parkinson:2015gt]. Likewise, the apparent generalists *Symbiodinium* C3 (which dominated colonies of both *S. siderea* and *M. cavernosa*) and *Symbiodinium* A4 (which dominated both *P. astreoides* and *P. furcata*) may also be comprised of multiple specialized lineages [@Thornhill:2013dx], which will require evaluation with higher resolution genetic markers.
  ...
  Finally, to reveal symbionts that consistently occupied a 'background' niche, we identified OTUs present at <1% relative abundance in at least three different host species. Such a distribution suggests that these symbionts can occupy a range of hosts, but are unlikely to dominate them under prevailing environmental conditions. Their presence, however, indicates that they may be able to achieve dominance under certain conditions. Indeed, the most prevalent 'background' symbiont in St. John was a member of clade D (*Symbiodinium trenchii* [@LaJeunesse:2014io], present in seven out of ten host species), which has been shown to proliferate within hosts during and after thermal stress [@Thornhill:2006p3638; @LaJeunesse:2009p7364; @Silverstein:2015er], or in more marginal environments [@LaJeunesse:2010p7790]. Association with these symbionts may therefore broaden a host's fundamental niche space and increase its resilience to environmental change [@Correa:2010p7787]. *Symbiodinium* A4 and C3 also commonly occurred as background symbionts, suggesting they may perform analogous functional and ecological roles within the metacommunity.
  
  Focusing on hosts, there was a clear difference among species in the number of OTUs that were abundant (>1% relative abundance, Fig. 4) and dominant (>50% relative abundance, Fig. 5A), indicating different levels of variability in the symbiosis ecology of different coral species. *D. strigosa* individuals could be dominated by four different OTUs, while all *D. cylindrus*, *S. radians*, *M. cavernosa*, and *P. astreoides* individuals were dominated by a single OTU. In fact, this variability, or 'flexibility' in the symbiosis ecology of a host species, can be quantified as multivariate dispersion (a metric of beta diversity) using metabarcoding data, which can be statistically compared among species [@Anderson:2006fs]. The flexibility of symbiosis is important as a potential indicator of the environmental sensitivity of a species [@Putnam:2012wv], and its ability to switch or shuffle its symbionts. This metric revealed that *M. cavernosa*, *P. astreoides*, *S. radians*, and *D. cylindrus* all had the lowest symbiotic flexibility. On the other hand, *D. strigosa*, *P. furcata*, *M. alcicornis*, and *S. siderea* had the most variable symbiont communities, indicating that these species may be more 'flexible' in their associations, and that their symbiont community structure may be more responsive to variability in the natural environment.
  
#### Conclusions

  While not providing species-level resolution, ITS2 metabarcoding represents a powerful approach to quantitatively and comprehensively describe *Symbiodinium* metacommunity composition on coral reefs. With appropriate bioinformatic interpretation, these datasets can address critical topics in coral symbiosis ecology, including the influence of the environment on community structure, and changes in dominant or background symbiont abundance over environmental gradients or over time, with important implications for understanding coral responses to environmental change.
