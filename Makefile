all: data/otus_97/97_otus.tsv data/otus_97/blast_tophits.txt data/otus_97/nw_tophits.tsv data/otus_97_bysample/97_otus_bysample.tsv data/otus_97_bysample/blast_tophits.txt data/otus_97_bysample/nw_tophits.tsv data/otus_100/100_otus.tsv data/otus_100/blast_tophits.txt data/otus_100/nw_tophits.tsv data/otus_97_byspecies/97_otus_byspecies.tsv data/otus_97_byspecies/blast_tophits.txt data/otus_97_byspecies/nw_tophits.tsv

data/otus_97/blast_tophits.txt: data/otus_97/97_otus_rep_set.fasta data/ITS2db_trimmed_derep.fasta Shell/run_blast.sh
	bash Shell/run_blast.sh $< data/ITS2db_trimmed_derep.fasta
...
data/otus_97_bysample/blast_tophits.txt: data/otus_97_bysample/all_rep_set_rep_set.fasta data/ITS2db_trimmed_derep.fasta Shell/run_blast.sh
	bash Shell/run_blast.sh $< data/ITS2db_trimmed_derep.fasta
...
data/otus_97_byspecies/blast_tophits.txt: data/otus_97_byspecies/all_rep_set_rep_set.fasta data/ITS2db_trimmed_derep.fasta Shell/run_blast.sh
	bash Shell/run_blast.sh $< data/ITS2db_trimmed_derep.fasta
...
data/otus_100/blast_tophits.txt: data/otus_100/100_otus_rep_set.fasta data/ITS2db_trimmed_derep.fasta Shell/run_blast.sh
	bash Shell/run_blast.sh $< data/ITS2db_trimmed_derep.fasta
